...
//2. Переход в личный кабинет
    ...
    public void openPage() throws InterruptedException {
        ...
        driver.findElement(By.id("id_fname_latin")).sendKeys("Nataliia");
        driver.findElement(By.id("id_lname")).sendKeys("Софиеч");
        driver.findElement(By.id("id_lname_latin")).sendKeys("Sofiech");
        ...
        Assertions.assertEquals("Тюмень", driver.findElement(By.cssSelector(".js-lk-cv-dependent-slave-city > label:nth-child(1) > div:nth-child(2)")).getText());
